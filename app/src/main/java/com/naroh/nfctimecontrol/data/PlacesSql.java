...
public class PlacesSql extends SQLiteOpenHelper {
    ...
    String creation = "CREATE TABLE places (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, placename varchar(255) NOT NULL, checkin varchar(255) NOT NULL, checkout varchar(255))";
